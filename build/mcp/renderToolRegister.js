...
export function registerRenderingTools(server) {
    ...
    registerAppResource(server, "Chess Board Viewer", chessBoardResourceUri, {
    ...
    // Chess Board Tool
    registerAppTool(server, "render_chess_board", {
    ...
    registerAppResource(server, "PGN Game Viewer", pgnViewerResourceUri, {
    ...
    // PGN Viewer Tool
    registerAppTool(server, "render_pgn_viewer", {
