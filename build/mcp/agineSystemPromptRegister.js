...
export function registerAgineSystemPrompt(server) {
    ...
    server.registerPrompt("question-answer-mode", {
    ...
    server.registerPrompt("annotation-expert", {
    ...
    server.registerPrompt("dashboard-designer", {
...
Use chess notation and be specific about piece placements and tactical motifs. Conclude with an evaluation (advantage to white/black/equal) and recommend the best continuation.`,
    ...
    server.registerPrompt("find-tactics", {
...
4. The resulting advantage`,
    ...
    server.registerPrompt("opening-analysis", {
...
Use opening theory and explain strategic concepts clearly.`,
    ...
    server.registerPrompt("endgame-analysis", {
...
Be precise with move sequences and explain the underlying theory.`,
    ...
    server.registerPrompt("annotate-game", {
...
6. **Lessons**: What can be learned from comparing these games?`,
    ...
    // Training Prompts
    server.registerPrompt("explain-mistake", {
...
Be educational and help understand the concept, not just memorize.`,
    ...
    server.registerPrompt("create-training-plan", {
...
Make it practical and actionable.`,
    ...
    // Repertoire Building
    server.registerPrompt("build-repertoire", {
...
Make recommendations practical and achievable, not too broad.`,
    ...
    // Pattern Recognition
    server.registerPrompt("identify-patterns", {
