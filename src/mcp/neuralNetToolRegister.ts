...
export function registerNeuralNetTools(server: McpServer): void {
  postToolAdapter(server, {
    ...
    description:
      "Analyze chess position using Maia3 neural network trained on human games at specific rating levels. Provides human-like move suggestions and evaluations tailored to player strength (600-2600 rating).",
